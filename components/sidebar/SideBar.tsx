...
export default function SideBar() {
    ...
    return (
        <div className="fixed top-0 left-0 w-20 h-screen bg-background-primary p-4 shadow-lg flex flex-col items-center z-20">
            {/* Navigation Items */}
            <ul className="list-none p-0 m-0 flex flex-col gap-6">
                {list.map((item) => {
                    ...
                    return (
                        <li
                            key={item.url}
                            className={`relative flex justify-center items-center cursor-pointer rounded-xl p-2 w-12 h-12 transition-all duration-300 ${isSelected
